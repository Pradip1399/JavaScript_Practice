...
const checkWinner = (avgDolhins, avgKoalas) => {
    ...
    {
        console.log(`Team Dolhpin wins (${avgDolhins.toFixed(2)} vs ${avgKoalas.toFixed(2)})`);
    }
    else if(averageDolphin < averageKoalas)
    {
        console.log(`Team Koalas wins (${avgDolhins} vs ${avgKoalas})`);
    }
    else
    {
        console.log(`Draw (${avgDolhins} vs ${avgKoalas})`);
    }
}

const averageDolphin = calcAverage(dolphinScore1, dolphinScore2, dolphinScore3);
...
console.log(`Biils : ${bills}, Tips : ${tips}, Totals : ${totals}`);
