...
// BONUS 1
const scoreDolphins = (120 + 112 + 80) / 3;
...
const tip = bill < 50 ? 0 : ( (bill >= 50 && bill <= 300) ? 0.15 * bill : 0.20 * bill)

const finalValue = bill + tip;

console.log(`Bill : ${bill}, Tip : ${tip}, final value (bill + tip) : ${finalValue}`)